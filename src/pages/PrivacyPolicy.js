        ...
        <div className="row my-2">
          <div class="card col-10 mx-auto bg-light">
            <div class="card-body">
              ...
              <center><a href="https://firebasestorage.googleapis.com/v0/b/vendur-mart.appspot.com/o/Privacy%20Policy.pdf?alt=media&token=3b0a6d87-02da-4aeb-96eb-0f7fc33ad8dd" target="_blank" class=" text-center card-link btn border-0 bg-theme navbar-brand text-fluid ms-5 text-size2 text-decoration-none text-light zoom1">Download Privacy Policy</a></center>
            </div>
          </div>
        </div>
        </div>
